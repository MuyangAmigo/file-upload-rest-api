...
import com.antra.archive.service.Document;
import com.antra.archive.service.DocumentMetadata;
...
public class FileSystemDocumentDao implements IDocumentDao {
     ...
     * 
     * @see com.antra.archive.dao.IDocumentDao#insert(com.antra.archive.service.Document)
     */
    @Override
     ...
     * the parameter.
     * 
     * @see com.antra.archive.dao.IDocumentDao#findByPersonNameDate(java.lang.String, java.util.Date)
     */
    @Override
     ...
     * 
     * @see com.antra.archive.dao.IDocumentDao#load(java.lang.String)
     */
    @Override
